...
class RoomManagementController extends Controller
{
    public function index()
    {
        ...
        \Log::info('RoomManagement index method called');
        \Log::info('Authenticated user: ' . auth()->user()->name ?? 'None');
        \Log::info('User role: ' . auth()->user()->user_role ?? 'None');
        ...
        \Log::info('Rendering RoomManagement with ' . $rooms->count() . ' rooms and ' . $venues->count() . ' venues');
